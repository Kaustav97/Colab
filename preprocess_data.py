...
new_img_height = 360 # (the height all images fed to the model will be resized to)
new_img_width = 1200 # (the width all images fed to the model will be resized to)
no_of_classes = 1 # (number of object classes (road, sidewalk, car etc.))
